        ...
        {steps.map((s, idx) => {
          ...
          return (
            <div key={s.title} className="relative flex flex-col items-center text-center group">
              <div className="w-16 h-16 rounded-2xl bg-[#151F32] border border-[#334155] flex items-center justify-center mb-4 transition-transform duration-200 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(255,255,255,0.08)]">
